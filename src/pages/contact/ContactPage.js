...
export default function Contact() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost:8080/api/contact/contact", {
        method: "POST",
        headers: {
      ...
      setMsg("G�� Message sent! We will contact you soon.");
        ...
        <div>
          ...
          <div className="bullets" style={{ marginTop: 14 }}>
            {[
              ...
              ["Office Hours", "MonG��Sat G�� 9:00 AM G�� 6:00 PM"],
          ...
          <p className="muted" style={{ marginTop: 12 }}>
            Share your requirement and preferred ISO standard, weG��ll guide you step-by-step.
          </p>
        </div>

        <div className="card glass">
          <h3>Send a Message</h3>
          <p className="muted">WeG��ll respond within 24 hours.</p>
